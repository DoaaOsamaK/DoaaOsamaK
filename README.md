...
![Skills](https://skillicons.dev/icons?i=c,cpp,cs,java,python,html,css,bootstrap,jquery,js,tailwind,expressjs,php,nodejs,gcp,react,mysql,figma,git,github,githubactions,bash,md,vscode,visualstudio,photoshop,illustrator,xd,discord,dart,flutter,unity,postgresql,linkedin,autocad&perline=11)
